    ...
    <PanelCard>
      <div className="border-b border-border/60 px-5 py-3.5">
        ...
        <p className="text-[12px] text-muted-foreground">
          Simulates who is signed in. Gates who may upload, submit, and approve across the module —
          a preview of the permission model, not enforcement.
        </p>
      </div>
      ...
      <div className="grid items-start gap-4 xl:grid-cols-2">
        <PanelCard>
          <div className="border-b border-border/60 px-5 py-3.5">
            ...
            <p className="text-[12px] text-muted-foreground">
              Renewal lead windows are per type — a fire <A t="NOC" /> and an <A t="ISO" />{" "}
              certificate warrant different warning horizons. These windows drive every alert.
              Renewal-bearing licences carry a 90-day (3-month) floor; edit any window below.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <PanelCard>
            <div className="border-b border-border/60 px-5 py-3.5">
              ...
              <p className="text-[12px] text-muted-foreground">
                One definition source feeds every dotted-underline popover across the module —
            ...
            <div className="border-b border-border/40 px-5 py-3">
              <Input
                ...
                className="h-9 bg-muted/40 text-[12.5px]"
              ...
              <div className="max-h-[360px] divide-y divide-border/30 overflow-auto">
                {terms.map(([k, v]) => (
                  <div key={k} className="flex items-baseline gap-3 px-5 py-2.5">
                    <span className="num w-[74px] shrink-0 text-[12px] font-bold text-primary">
                      {k}
                    </span>
                    <span>
          ...
          <PanelCard>
            <div className="border-b border-border/60 px-5 py-3.5">
              ...
              <p className="text-[12px] text-muted-foreground">
                Carried from the BRD, on the record rather than silently resolved.
              </p>
            </div>
            <ul className="space-y-2 px-5 py-4 text-[12.5px] leading-relaxed">
              {[
                <>
                  Entity list & hierarchy to be confirmed — it shapes every roll-up on the
                  dashboard.
                </>,
                <>
                  Vendor bulk documents: keep in-module or defer to a separate <A t="DMS" />? Phase
                  1 captures the compliance sheet either way.
                </>,
                <>
                  Asset-master integration for the adequacy assessments <A t="ESAP" /> references.
                </>,
                <>
                  <A t="ISO" /> 9001 certification is in progress — third certificate joins the
                  register on award.
                </>,
              ].map((item, i) => (
