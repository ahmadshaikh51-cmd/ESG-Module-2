  ...
  return (
    <div className="space-y-4">
            ...
            <tbody>
              {filtered.map((r) => (
                ...
                >
                  ...
                  <td
                    className={`px-3 py-2.5 num ${r.avg_charging_power_kw > medians.busPower ? "text-warning" : "text-success"}`}
                  >
                    {fmt(r.avg_charging_power_kw, 1)}
                  </td>
                  <td className="px-3 py-2.5 num">{fmt(r.avg_soc_delta, 0)}%</td>
                  <td
                    className={`px-3 py-2.5 num ${r.thermal_stress > medians.busThermal ? "text-destructive" : ""}`}
                  >
                  ...
                  <td className="px-3 py-2.5 num text-destructive">
                    {fmt(r.abnormality_score, 0)}
                  </td>
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        <Panel className="p-5">
          <PanelHeader
            title="Fleet abnormality trend"
            description="Abnormal buses, health, disconnects & thermal stress."
          />
          <div className="h-64">
              ...
              <ScatterChart margin={{ top: 8, right: 12, bottom: 8, left: 0 }}>
                ...
                <Scatter
                  ...
                  shape={(props: {
                    cx?: number;
                    cy?: number;
                    payload?: { risk: keyof typeof RISK_COLOR };
                  }) => {
      ...
      <Panel>
        <PanelHeader
          title="Bus thermal intelligence"
          description="Persistent thermal stress — darker = higher rise."
        />
