          ...
          <SheetHeader className="sticky top-0 z-10 px-6 py-5 border-b border-border/40 bg-card/80 backdrop-blur-xl">
            ...
            <div className="mt-5 grid grid-cols-3 gap-3">
              ...
              <div className="rounded-xl border border-warning/30 bg-warning/5 p-3">
                <div className="text-[10px] font-medium uppercase tracking-wider text-warning-foreground">
                  Pending
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex w-full items-start justify-between gap-4">
                          ...
                          {task.deadline && (
                            <span
                              className={`shrink-0 rounded-md px-2 py-0.5 text-[11px] font-semibold ring-1 ${toneClass}`}
                            >
                              {badge.label}
                            </span>
                          )}
