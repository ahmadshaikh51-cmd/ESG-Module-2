      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-[12.5px] text-muted-foreground">
            ...
            <span className="num font-medium text-primary">({metric.format(medianVal)})</span> —
            min. 50 trips.
          </p>
        </div>
  ...
  return (
    <div>
      <div className="mb-2 flex items-center gap-2">
        <span
          className={`inline-flex h-6 items-center gap-1 rounded-md px-2 text-[11px] font-medium ring-1 ${accent}`}
        >
          {icon} {title}
        </span>
      </div>
